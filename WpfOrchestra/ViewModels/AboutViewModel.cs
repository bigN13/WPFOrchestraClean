...
namespace WpfOrchestra.ViewModels
{
    ...
    public class AboutViewModel : ViewModelBase
    {
        ...
        public AboutViewModel(IModuleInfoManager moduleInfoManager, IProcessService processService)
        {
            ...
            var tempModules = knownModules.Select(moduleInfo => new Models.ModuleInfo()
            {
                ...
                LicenseUrl = ((Orchestra.Modules.ModuleBase)ServiceLocator.ResolveType(TypeCache.GetType(moduleInfo.ModuleType))).GetLicenseUrl()
            }).ToList();
